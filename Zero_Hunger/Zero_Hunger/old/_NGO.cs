...
namespace Zero_Hunger.Models
{
    public class _NGO
    {
        ...
        public virtual ICollection<_Employee> Employees { get; set; }

        // One-to-many relationship with Restaurant
        public virtual ICollection<_Restaurant> Restaurants { get; set; }


        public _NGO()
        {
            Employees = new List<_Employee>();
            Restaurants = new List<_Restaurant>();
        }
    }
}
