...
namespace Zero_Hunger.Models
{
    public class _Employee
    {
        ...
        public virtual ICollection<_CollectRequest> Collections { get; set; }
        public virtual ICollection<_DistributionRecord> DistributionRecords { get; set; }
        public _Employee()
        {
            Collections = new List<_CollectRequest>();
            DistributionRecords = new List<_DistributionRecord>();
        }
    }
}
